...
def sendEmail(link,text,email,me,password):
	# Create message container - the correct MIME type is multipart/alternative.
	msg = MIMEMultipart('alternative')
	msg['Subject'] = u"Новый пользователь"
	msg['From'] = me
	msg['To'] = email
                    ...
                    <table cellspacing="0" cellpadding="0" width="600" class="w320">
                      <tr>
                        <td align="center" valign="top">
                          ...
                          <table class="force-full-width" style="width:100%;" cellspacing="0" cellpadding="20" bgcolor="#2b934f">
                            <tr>
